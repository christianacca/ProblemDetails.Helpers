...
namespace CcAcca.ProblemDetails.Helpers.Tests.EnsurePostJsonAsync
{
    public class SuccessResponse : SuccessResponseBase
    {
        ...
        {
            // when
            var response = await Client.EnsurePostJsonAsync(Url, Model);
        ...
        public async void String_Url_JsonSerializerOptions_ResponseMessage()
        {
            // when
            var response =
                await Client.EnsurePostJsonAsync(Url, Model, Options);
            var result = await response.Content.ReadFromJsonAsync<ExampleModel>();
        ...
        public async void String_Url_JsonSerializerOptions_CancellationToken_ResponseMessage()
        {
            ...
            var response = await Client
                .EnsurePostJsonAsync(Url, Model, Options, CancellationToken.None);
            var result = await response.Content.ReadFromJsonAsync<ExampleModel>();
        ...
        {
            // when
            var response = await Client.EnsurePostJsonAsync(Url, Model, CancellationToken.None);
            var result = await response.Content.ReadFromJsonAsync<ExampleModel>();
        ...
        {
            // when
            var response = await Client.EnsurePostJsonAsync(Uri, Model);
            var result = await response.Content.ReadFromJsonAsync<ExampleModel>();
        ...
        {
            // when
            var response = await Client.EnsurePostJsonAsync(Uri, Model, Options);
            var result = await response.Content.ReadFromJsonAsync<ExampleModel>();
        ...
        public async void Uri_JsonSerializerOptions_CancellationToken_ResponseMessage()
        {
            // when
            var response = await Client
                .EnsurePostJsonAsync(Uri, Model, Options, CancellationToken.None);
            var result = await response.Content.ReadFromJsonAsync<ExampleModel>();
        ...
        {
            // when
            var response = await Client.EnsurePostJsonAsync(Uri, Model, CancellationToken.None);
            var result = await response.Content.ReadFromJsonAsync<ExampleModel>();
        ...
        public async void String_Url_Result_Type()
        {
            // when
            var result =
                await Client.EnsurePostJsonAsync<ExampleModel, ExampleModel>(Url, Model);
        ...
        public async void String_Url_JsonSerializerOptions_Result_Type()
        {
            ...
            var result = await Client
                .EnsurePostJsonAsync<ExampleModel, ExampleModel>(Url, Model, Options);
        ...
        public async void Uri_Result_Type()
        {
            // when
            var result =
                await Client.EnsurePostJsonAsync<ExampleModel, ExampleModel>(Uri, Model);
        ...
        public async void Uri_JsonSerializerOptions_Result_Type()
        {
            // when
            var result = await Client
                .EnsurePostJsonAsync<ExampleModel, ExampleModel>(Uri, Model, Options);
        ...
        {
            // when
            var result = await Client.EnsurePostJsonAsync(Url, Model, typeof(ExampleModel));
        ...
        public async void String_Url_JsonSerializerOptions_Result_Object()
        {
            // when
            var result = await Client
                .EnsurePostJsonAsync(Url, Model, typeof(ExampleModel), Options);
        ...
        {
            // when
            var result = await Client.EnsurePostJsonAsync(Uri, Model, typeof(ExampleModel));
