...
namespace CcAcca.ProblemDetails.Helpers
{
    ...
    {
        /// <summary>
        ///     Send a POST request to the specified Uri containing the <paramref name="value" /> serialized as JSON in
        ...
        public static Task<object> EnsurePostJsonAsync<TValue>(this HttpClient client, string requestUri,
            ...
            client.EnsurePostJsonAsync(requestUri, value, returnType, null, cancellationToken);
