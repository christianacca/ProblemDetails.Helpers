...
namespace CcAcca.ProblemDetails.Helpers
{
    public static partial class HttpClientJsonExtensions
    {
        ...
        {
            return client.EnsurePutAsJsonAsync(requestUri, value, null, cancellationToken);
        }
        ...
        public static async Task<TResult> PutAsJsonAsync<TValue, TResult>(this HttpClient client, string requestUri,
            TValue value, JsonSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            var response = await client.EnsurePutAsJsonAsync(requestUri, value, options, cancellationToken)
                .ConfigureAwait(false);
            return await response.Content.ReadFromJsonAsync<TResult>(options, cancellationToken).ConfigureAwait(false);
        }

        public static async Task<TResult> PutAsJsonAsync<TValue, TResult>(this HttpClient client, Uri requestUri,
            TValue value, JsonSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            var response = await client.EnsurePutAsJsonAsync(requestUri, value, options, cancellationToken)
                .ConfigureAwait(false);
        ...
        public static Task<TResult> PutAsJsonAsync<TValue, TResult>(this HttpClient client, string requestUri,
            TValue value, CancellationToken cancellationToken) =>
            client.PutAsJsonAsync<TValue, TResult>(requestUri, value, null, cancellationToken);

        public static Task<TResult> PutAsJsonAsync<TValue, TResult>(this HttpClient client, Uri requestUri,
            TValue value, CancellationToken cancellationToken) =>
            client.PutAsJsonAsync<TValue, TResult>(requestUri, value, null, cancellationToken);
    }
}
