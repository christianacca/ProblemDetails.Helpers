...
namespace CcAcca.ProblemDetails.Helpers
{
    public static partial class HttpClientJsonExtensions
    {
        public static Task<HttpResponseMessage> EnsureDeleteAsync(
            this HttpClient client, string requestUri) => client.EnsureDeleteAsync(requestUri, CancellationToken.None);

        public static Task<HttpResponseMessage> EnsureDeleteAsync(
            this HttpClient client, Uri requestUri) => client.EnsureDeleteAsync(requestUri, CancellationToken.None);
